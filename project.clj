(defproject tile-map "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "tile-map.core/on-js-reload"
                ...
                :compiler {:main tile-map.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/tile_map.js"
